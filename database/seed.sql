...
('ali.raza@student.com', '$2b$12$STtHVc6e7M4.T/OsHZZ3qu.cEF7bbkp0Y/Wq7qkItRrQtRqprHSXy', 'Student', 'Ali Raza', '03001111101',
 (SELECT dept_id FROM departments WHERE dept_code='CS'), '2024-CS-001',
...
('sara.khan@student.com', '$2b$12$STtHVc6e7M4.T/OsHZZ3qu.cEF7bbkp0Y/Wq7qkItRrQtRqprHSXy', 'Student', 'Sara Khan', '03001111102',
 (SELECT dept_id FROM departments WHERE dept_code='CS'), '2024-CS-002',
 (SELECT program_id FROM programs WHERE program_code='BS-CS'),
 (SELECT s.sem_id FROM semesters s JOIN programs p ON s.program_id=p.program_id WHERE p.program_code='BS-CS' AND s.is_active=TRUE LIMIT 1)),
('hamza.ali@student.com', '$2b$12$STtHVc6e7M4.T/OsHZZ3qu.cEF7bbkp0Y/Wq7qkItRrQtRqprHSXy', 'Student', 'Hamza Ali', '03001111201',
 (SELECT dept_id FROM departments WHERE dept_code='IT'), '2024-IT-001',
...
('manahil.rauf@student.com', '$2b$12$STtHVc6e7M4.T/OsHZZ3qu.cEF7bbkp0Y/Wq7qkItRrQtRqprHSXy', 'Student', 'Manahil Rauf', '03001111301',
 (SELECT dept_id FROM departments WHERE dept_code='SE'), '2024-SE-001',
...
('rayyan.ahmed@student.com', '$2b$12$STtHVc6e7M4.T/OsHZZ3qu.cEF7bbkp0Y/Wq7qkItRrQtRqprHSXy', 'Student', 'Rayyan Ahmed', '03001111401',
 (SELECT dept_id FROM departments WHERE dept_code='AI'), '2024-AI-001',
